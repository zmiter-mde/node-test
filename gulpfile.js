 ...
 * optimize before handling image or fonts
 */
gulp.task('build-skip-tests', ['optimize-skip-tests', 'images', 'fonts'], function() {
    log('Building everything without running karma and without ng-annonate');
 ...
 * @return {Stream}
 */
gulp.task('optimize-skip-tests', ['inject'], function() {
    log('Optimizing the js, css, and html');
